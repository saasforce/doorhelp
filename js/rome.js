   ...
   'use strict';
	...
	$(document).scroll(function() { 
		...
		if($(this).scrollTop()>100) {
			$('header').stop().animate({ backgroundColor: '#fff' }, 'fast');
		} else {
...
$(window).load(function() {
    ...
    setTimeout(function(){$('#home .phone').addClass('animated fadeInLeft')},600);
    setTimeout(function(){$('#home .info').addClass('animated fadeInRight')},600);
/*
